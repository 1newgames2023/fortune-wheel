...
class FortuneWheel extends HookWidget implements FortuneWidget {
  ...
  final Stream<int> selectionStream;
  ...
  FortuneWheel({
    ...
    this.selectionStream = const Stream<int>.empty(),
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      final subscription = selectionStream.listen((event) {
